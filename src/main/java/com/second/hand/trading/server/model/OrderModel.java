...
public class OrderModel implements Serializable {
    ...
    /*
    商品列表 一个订单中存储多个商品,将其序列化，保存在数据库中
    * */

    @TableField(exist = false)
    @JSONField(serialize = false)
    private OrderVo orderVoList;

    public OrderVo getOrderVoList() {
        return orderVoList;
    }

    public void setOrderVoList(OrderVo orderVoList) {
        this.orderVoList = orderVoList;
    }

    /*设置一个变量与数据库中的idle_items对应*/
    @TableField("idle_items")
    private String idle_items;


    public String getIdle_items() {
        return idle_items;
    }

    public void setIdle_items(String idle_items) {
        this.idle_items = idle_items;
    }
